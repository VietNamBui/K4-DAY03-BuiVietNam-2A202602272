...
`*` Log Colab chỉ cho thấy đã chạy đánh giá trên annotation hiện tại; chưa có artifact hoặc số liệu riêng chứng minh một bản rework sau khi sửa CVAT. Vì vậy không nên gọi dòng này là kết quả sau rework nếu chưa export lại nhãn.
